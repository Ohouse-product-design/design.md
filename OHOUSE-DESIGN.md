...
components:
  ...
  box-button-brand-solid:
    ...
    padding: 16px
    height: 48px
    typography: "{typography.body-16-medium}"
  box-button-brand-solid-disabled:
  ...
  input-default:
    ...
    padding: 12px
    height: 48px
    typography: "{typography.body-16-regular}"
  input-error:
    backgroundColor: "{colors.background}"
    textColor: "{colors.foreground-critical}"
    rounded: "{rounded.sm}"
    padding: 12px
    height: 48px
    typography: "{typography.body-16-regular}"
  ...
  chip-default:
    ...
    padding: 12px
    height: 32px
    typography: "{typography.detail-13-regular}"
  chip-selected:
    backgroundColor: "{colors.background-brand-weak}"
  ...
  empty-title:
    backgroundColor: "transparent"
    textColor: "{colors.foreground}"
    typography: "{typography.heading-18-semibold}"
  empty-description:
    backgroundColor: "transparent"
